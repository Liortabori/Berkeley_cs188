...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        self.cornersNotVisited = [c for c in self.corners]
        self.actionCost = 1
        self.numGoalStates = 4
    ...
    def isGoalState(self, state):
        ...
        """
        if state in self.cornersNotVisited:
            self.cornersNotVisited.remove(state)
            return True
        else:
            return False
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                successors.append(((nextx, nexty), action, self.actionCost))
